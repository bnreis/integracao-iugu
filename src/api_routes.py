...
class CriarEmpresaRequest(BaseModel):
    ...
    inscricao_municipal: str = PydField("", description="Inscricao Municipal do tomador (exigida na retencao)")
...
async def editar_empresa(cnpj: str, req: EditarEmpresaRequest):
    ...
    campos_negocio = [
        ...
        "descricao_boleto", "valor_fatura", "dia_criacao_fatura", "ativo", "observacoes",
    ]
